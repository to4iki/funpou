...
- refactor: clean up minor issues and add CLI integration tests by @to4iki in https://github.com/to4iki/funpou/pull/42
- chore: remove CLI integration tests and trim unit tests by @to4iki in https://github.com/to4iki/funpou/pull/43
